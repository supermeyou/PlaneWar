...
#define GAME_HEIGHT 680 //高度
#define GAME_TITLE "Superyou飞机大战 v1.0" //标题
#define GAME_RES_PATH "./plane.rcc" //rcc文件路径
#define GAME_ICON ":/res/app.ico"
#define GAME_RATE 10 //定时器刷新间隔，帧率 /单位毫秒
...
/********** 飞机配置数据 **********/
#define HERO_PATH ":/res/hero2.png"  //英雄机的文件位置
...
/********** 爆炸配置数据 **********/
#define BOMB_PATH ":/res/bomb-%1.png" //爆炸资源图片 这里有个技巧，利用%1的下标来巧妙表示几张图片
